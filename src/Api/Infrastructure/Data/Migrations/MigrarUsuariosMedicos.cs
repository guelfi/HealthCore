...
namespace MobileMed.Api.Infrastructure.Data.Migrations
{
    /// <inheritdoc />
    public partial class MigrarUsuariosMedicos : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Migrar usuários com role de médico para a tabela Médicos
        ...
        {
            // Remover os registros criados por esta migração
            migrationBuilder.Sql(@"
                DELETE FROM Medicos 
                WHERE UserId IN (
