...
const MobileDebugger: React.FC<MobileDebuggerProps> = ({ 
  enabled = import.meta.env.DEV && import.meta.env.VITE_ENABLE_DEBUGGER === 'true'
}) => {
    ...
    <>
      ...
      <Dialog open={open} onClose={() => setOpen(false)} maxWidth="sm" fullWidth>
        ...
        <DialogContent>
          ...
          <Typography>Environment: {import.meta.env.VITE_APP_ENVIRONMENT || 'development'}</Typography>
          <Typography>Version: {import.meta.env.VITE_APP_VERSION || '1.0.0'}</Typography>
