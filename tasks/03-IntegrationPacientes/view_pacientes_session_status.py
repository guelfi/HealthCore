...
def main():
    ...
    # Header
    color_log("\n🚀 STATUS DA INTEGRAÇÃO DE PACIENTES", Colors.CYAN)
    ...
    color_log("  python scripts/update-task.py pacientes task_id COMPLETE \"Descrição\"", Colors.GRAY)
    ...
    color_log("\n", Colors.WHITE)
    color_log("=" * 60, Colors.CYAN)
    color_log("🚀 Pronto para começar a integração de Pacientes!", Colors.GREEN)
