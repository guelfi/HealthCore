#!/usr/bin/env python3
"""
Script para visualizar status da sessão de integração de Médicos
...
def main():
    ...
    # Header
    color_log("\n🚀 STATUS DA INTEGRAÇÃO DE MÉDICOS", Colors.CYAN)
    ...
    color_log("  python scripts/update-task.py medicos task_id COMPLETE \"Descrição\"", Colors.GRAY)
    ...
    color_log("\n", Colors.WHITE)
    color_log("=" * 60, Colors.CYAN)
    color_log("🚀 Pronto para começar a integração de Médicos!", Colors.GREEN)
