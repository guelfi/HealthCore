#!/usr/bin/env python3
"""
Script para visualizar status da sessão de integração de Exames
...
def main():
    ...
    # Header
    color_log("\n🚀 STATUS DA INTEGRAÇÃO DE EXAMES", Colors.CYAN)
    ...
    color_log("  python scripts/update-task.py exames task_id COMPLETE \"Descrição\"", Colors.GRAY)
    ...
    color_log("\n", Colors.WHITE)
    color_log("=" * 60, Colors.CYAN)
    color_log("🚀 Pronto para começar a integração de Exames!", Colors.GREEN)
